	...
	switch ($draggedNode['module']) {
		...
		case 'asol_Task':
			...
			switch ($bean->task_type) {
				case 'send_email':
					$bean->task_implementation = '${pipe}${pipe}${pipe}${pipe}${pipe}${pipe}${pipe}${pipe}${pipe}${pipe}${pipe}${pipe}${pipe}${pipe}';
					break;
				case 'php_custom':
				...
				case 'modify_object':
					...
					break;
				case 'call_process':
					$bean->task_implementation = '${pipe}${pipe}${pipe}${pipe}false';
					break;
