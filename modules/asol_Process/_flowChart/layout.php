			...
			<div id="newObjects">
				<ul>
					...
					<li rel="asol_Task">
						...
						<ul>
							<li rel="asol_Task_send_email">
								<a href="#" layoutId="newObjects" layoutId="newObjects" module="asol_Task" task_type="send_email"><?php echo $app_list_strings['wfm_task_type_list']['send_email']; ?></a>
							</li>
							<li rel="asol_Task_php_custom">
								<a href="#" layoutId="newObjects" module="asol_Task" task_type="php_custom"><?php echo $app_list_strings['wfm_task_type_list']['php_custom']; ?></a>
							</li>
							<li rel="asol_Task_continue">
								<a href="#" layoutId="newObjects" module="asol_Task" task_type="continue"><?php echo $app_list_strings['wfm_task_type_list']['continue']; ?></a>
							</li>
							<li rel="asol_Task_end">
								<a href="#" layoutId="newObjects" module="asol_Task" task_type="end"><?php echo $app_list_strings['wfm_task_type_list']['end']; ?></a>
							</li>
							<li rel="asol_Task_create_object">
								<a href="#" layoutId="newObjects" module="asol_Task" task_type="create_object"><?php echo $app_list_strings['wfm_task_type_list']['create_object']; ?></a>
							</li>
							<li rel="asol_Task_modify_object">
								<a href="#" layoutId="newObjects" module="asol_Task" task_type="modify_object"><?php echo $app_list_strings['wfm_task_type_list']['modify_object']; ?></a>
							</li>
							<li rel="asol_Task_call_process">
								<a href="#" layoutId="newObjects" module="asol_Task" task_type="call_process"><?php echo $app_list_strings['wfm_task_type_list']['call_process']; ?></a>
							</li>
							<li rel="asol_Task_add_custom_variables">
								<a href="#" layoutId="newObjects" module="asol_Task" task_type="add_custom_variables"><?php echo $app_list_strings['wfm_task_type_list']['add_custom_variables']; ?></a>
							</li>
						</ul>
					</li>
				</ul>
