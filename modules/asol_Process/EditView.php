...
if (!empty($focusId)) { // Modify
	...
	$validationForTriggerModule = "addToValidate('EditView', 'trigger_module', 'enum', true, 'Module');";
}
							...
							<div>
								...
								<div class="edit view edit508  expanded" id="detailpanel_2">
									...
									<table cellspacing="1" cellpadding="0" width="100%" border="0" class="yui3-skin-sam edit view panelContainer" id="LBL_DB_CONFIGURATION_PANEL">
										<tbody>
											<tr>
												<td width="5%" valign="top" scope="col" id="alternative_database_label">
												...
												<td width="5%" valign="top" scope="col" id="trigger_module_label"> 
