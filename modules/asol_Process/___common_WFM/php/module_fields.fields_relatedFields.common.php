...
wfm_utils::wfm_log('asol_debug', '1', __FILE__, __METHOD__, __LINE__);
...
wfm_utils::wfm_log('asol_debug', '2', __FILE__, __METHOD__, __LINE__);
...
wfm_utils::wfm_log('asol_debug', '3', __FILE__, __METHOD__, __LINE__);
...
// js Language Files
if (!(($sel_altDb >= 0) && ($sel_altDbTable != ''))) {
	wfm_utils::wfm_log('asol_debug', '5', __FILE__, __METHOD__, __LINE__);
	if ($translateFieldLabels) {
		wfm_utils::wfm_log('asol_debug', '6', __FILE__, __METHOD__, __LINE__);
...
wfm_utils::wfm_log('asol_debug', '4', __FILE__, __METHOD__, __LINE__);
?>

<!-- Module Fields Select -->
<input
	type='hidden' id='rhs_key' name='rhs_key'
	value='<?php echo $rhs_key; ?>' />
