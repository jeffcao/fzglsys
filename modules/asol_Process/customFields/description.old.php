...
//wfm_utils::wfm_log('flow_debug', 'focus=['.print_r($bean, true).']', __FILE__, __METHOD__, __LINE__);
...
<script src="modules/asol_Process/___common_WFM/plugins_js_css_images/tinymce/tinymce.min.js?version=<?php wfm_utils::echoVersionWFM(); ?>" type="text/javascript"></script>
