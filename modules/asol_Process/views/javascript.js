...
function openFlowChartPopup(process_id, left, top) {
    var popup = window.open('index.php?entryPoint=wfm_layout&uid=' + process_id, process_id, 'top=150, left=150, width='+(screen.width-300)+', height='+(screen.height-300)+', type=fullWindow,fullscreen, location=no, menubar=no, resizable=yes, scrollbars=yes, status=no, titlebar=no, toolbar=no');
    popup.focus();
}
