...
'LBL_LIST_FORM_TITLE' => 'Lista de WFM Tareas',
'LBL_MODULE_NAME' => 'WFM Tarea',
'LBL_MODULE_TITLE' => 'WFM Tarea',
'LBL_HOMEPAGE_TITLE' => 'Mis WFM Tareas',
'LNK_NEW_RECORD' => 'Crear WFM Tarea',
'LNK_LIST' => 'Ver WFM Tarea',
'LNK_IMPORT_ASOL_TASK' => 'Importar WFM Tarea',
'LBL_SEARCH_FORM_TITLE' => 'Buscar WFM Tarea',
'LBL_HISTORY_SUBPANEL_TITLE' => 'Ver Historial',
'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Actividades',
'LBL_ASOL_TASK_SUBPANEL_TITLE' => 'WFM Tarea',
'LBL_NEW_FORM_TITLE' => 'Nueva WFM Tarea',
'LBL_DELAY_TYPE' => 'Tipo de Demora',
'LBL_DELAY' => 'Demora',
'LBL_TASK_ORDER' => 'Orden',
'LBL_TASK_TYPE' => 'Tipo de Tarea',
'LBL_TASK_IMPLEMENTATION' => 'Implementación de la Tarea',
...
// asol_task.js
'LBL_ASOL_TASK_JS_SEND_EMAIL_EMAIL_TPL' => 'Plt Emails',
'LBL_ASOL_TASK_JS_SEND_EMAIL_FROM' => 'De',
'LBL_ASOL_TASK_JS_SEND_EMAIL_ALL' => 'Resumen',
'LBL_ASOL_TASK_JS_SEND_EMAIL_ALL_TIP' => '(introducir datos TO-CC-BCC en otros tabs)',
'LBL_ASOL_TASK_JS_SEND_EMAIL_TO' => 'Para',
'LBL_ASOL_TASK_JS_SEND_EMAIL_CC' => 'CC',
'LBL_ASOL_TASK_JS_SEND_EMAIL_BCC' => 'BCC',
'LBL_ASOL_TASK_JS_SEND_EMAIL_USERS' => 'Usuarios',
'LBL_ASOL_TASK_JS_SEND_EMAIL_ROLES' => 'Roles',
'LBL_ASOL_TASK_JS_SEND_EMAIL_NOTIFICATIONEMAILS' => 'Emails Notificación',
'LBL_ASOL_TASK_JS_SEND_EMAIL_DISTRIBUTION_LIST' => 'Lista de Distribución',

'LBL_ASOL_TASK_JS_PHP_CUSTOM_PHP_CODE' => 'Código PHP',

'LBL_ASOL_TASK_JS_END_TERMINATE_PROCESS' => 'Terminar Proceso',

'LBL_ASOL_TASK_JS_CONTINUE_WAIT_FOR_SUGAR_TASK_TO_CONTINUE_PROCESS' => 'Esperar por Tarea Sugar para Continuar el Proceso',

'LBL_ASOL_TASK_JS_CALL_PROCESS_PROCESS' => 'Proceso',
'LBL_ASOL_TASK_JS_CALL_PROCESS_EVENT_FROM_PROCESS' => 'Evento del Proceso',
'LBL_ASOL_TASK_JS_CALL_PROCESS_EXECUTE_SUBPROCESS_IMMEDIATELY' => 'Ejecutar subproceso inmediatemante y esperar hasta que esté hecho',

//
'LBL_TASK_IMPLEMENTATION_PANEL' => 'Panel de Implementación de la WFM Tarea',
...
'LBL_ASOL_DATABASE_FIELD' => 'Añadir Campos',
'LBL_ASOL_VALUE' => 'Valor',

//
'LBL_ADD_NOT_A_FIELD_TITLE' => 'No-Campo',
'LBL_ADD_NOT_A_FIELD_BUTTON' => 'Añadir un No-Campo',
// module_fields.php
...
'LBL_ASOL_OBJECT_MODULE' => 'Módulo del Objeto',

'LBL_ASOL_DELETE_BUTTON' => 'Borrar Botón',
'LBL_ASOL_DELETE_ROW_ALERT' => '¿Borrar Campo?',
'LBL_ASOL_INSERT_NOT_ALLOWED_ALERT' => 'No Permitido',

// qtip_info for task_type
'LBL_ASOL_INFO_ICON_SEND_EMAIL' => '<b>Enviar Email</b> <br> Ejemplos de variables: <br> ${Users->created_by->email1} <br> ${old_bean->email1} <br> ${bean->email1} <br> ${old_bean->asol_email_list} <br> ${bean->asol_email_list}',
'LBL_ASOL_INFO_ICON_PHP_CUSTOM' => '<b>PHP a Medida</b> <br> Tienes acceso a estas variables-php: $task_id <br> $trigger_module <br> $bean_id <br> $old_bean <br> $new_bean <br> $current_user_id',
'LBL_ASOL_INFO_ICON_CONTINUE' => '<b>Continuar</b>',
'LBL_ASOL_INFO_ICON_END' => '<b>Terminar</b>',
'LBL_ASOL_INFO_ICON_CALL_PROCESS' => '<b>Llamar Proceso</b>',
...
'LBL_ACV_NAME' => 'Nombre',
'LBL_ACV_TYPE' => 'Tipo',
'LBL_ACV_MODULEFIELDS' => 'Campo del Módulo',
'LBL_ACV_FUNCTIONS' => 'Funciones',
'LBL_ACV_IS_GLOBAL' => 'Es Global?',

// Relatinships
'LBL_RELATIONSHIP_NAME' => 'Nombre Relación',
'LBL_RELATIONSHIP_VALUE' => 'Valor Relación',
'LBL_ADD_RELATIONSHIPS' => 'Añadir Relación',
