		...
		<table style="width:100%">
			<tbody>
				<tr>
									...
									<table cellspacing="1" cellpadding="0" width="100%" border="0" class="yui3-skin-sam edit view panelContainer" id="Default_asol_Task_Subpanel">
										<tbody>
											...
											<tr>
												...
												<td width="2%" valign="top" scope="col" id="delay_label"> <?php echo $mod_strings['LBL_DELAY']; ?>: </td>
												<td width="95%" valign="top" colspan="3">
											...
											<tr>
												...
												<td width="2%" valign="top" scope="col" id="task_order_label"> <?php echo $mod_strings['LBL_TASK_ORDER']; ?>: </td>
												<td width="15%" valign="top">
					...
					<br>
					<span style="white-space:nowrap;"> <a style="cursor: pointer;" onclick="openWFMVariableGenerator(100, 100);"> <img border="0" align="absmiddle" src="modules/asol_Process/___common_WFM/images/wfm_variable_generator.png" alt="<?php echo translate('LBL_WFM_VARIABLE_GENERATOR_BUTTON', 'asol_Process'); ?>"> <span><?php echo translate('LBL_WFM_VARIABLE_GENERATOR_BUTTON', 'asol_Process'); ?></span> </a> </span>
					<script>
