 ...
 * PLACE ANY CUSTOMIZATIONS IN fzgls_jiekuangren_dangan
 */

require_once('include/SugarObjects/templates/person/Person.php');

class fzgls_jiekuangren_dangan_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'fzgls_jiekuangren_dangan';
	var $object_name = 'fzgls_jiekuangren_dangan';
	var $table_name = 'fzgls_jiekuangren_dangan';
	...
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		function fzgls_jiekuangren_dangan_sugar(){	
		parent::Person();
	}
