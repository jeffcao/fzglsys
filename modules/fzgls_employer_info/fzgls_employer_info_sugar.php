 ...
 * PLACE ANY CUSTOMIZATIONS IN fzgls_employer_info
 */

require_once('include/SugarObjects/templates/person/Person.php');

class fzgls_employer_info_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'fzgls_employer_info';
	var $object_name = 'fzgls_employer_info';
	var $table_name = 'fzgls_employer_info';
	...
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		function fzgls_employer_info_sugar(){	
		parent::Person();
	}
