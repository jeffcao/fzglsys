 ...
 * PLACE ANY CUSTOMIZATIONS IN fzgls_hezuo_waibu_qudao
 */

require_once('include/SugarObjects/templates/company/Company.php');

class fzgls_hezuo_waibu_qudao_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'fzgls_hezuo_waibu_qudao';
	var $object_name = 'fzgls_hezuo_waibu_qudao';
	var $table_name = 'fzgls_hezuo_waibu_qudao';
	...
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		var $fzgls_hezuo_waibu_qudao_type;
		var $industry;
		var $annual_revenue;
		var $phone_fax;
		...
		function fzgls_hezuo_waibu_qudao_sugar(){	
		parent::Company();
	}
