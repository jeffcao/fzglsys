 ...
 * PLACE ANY CUSTOMIZATIONS IN fzgls_fenggongsi_info
 */

require_once('include/SugarObjects/templates/company/Company.php');

class fzgls_fenggongsi_info_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'fzgls_fenggongsi_info';
	var $object_name = 'fzgls_fenggongsi_info';
	var $table_name = 'fzgls_fenggongsi_info';
	...
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		var $fzgls_fenggongsi_info_type;
		var $industry;
		var $annual_revenue;
		var $phone_fax;
		...
		function fzgls_fenggongsi_info_sugar(){	
		parent::Company();
	}
