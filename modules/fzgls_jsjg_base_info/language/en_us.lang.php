...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => '金融机构基础数据 List',
  'LBL_MODULE_NAME' => '金融机构基础数据',
  'LBL_MODULE_TITLE' => '金融机构基础数据',
  'LBL_HOMEPAGE_TITLE' => 'My 金融机构基础数据',
  'LNK_NEW_RECORD' => 'Create 金融机构基础数据',
  'LNK_LIST' => 'View 金融机构基础数据',
  'LNK_IMPORT_FZGLS_JSJG_BASE_INFO' => '导入 金融机构基础数据',
  'LBL_SEARCH_FORM_TITLE' => 'Search 金融机构基础数据',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'View History',
  'LBL_FZGLS_JSJG_BASE_INFO_SUBPANEL_TITLE' => '金融机构基础数据',
  'LBL_NEW_FORM_TITLE' => 'New 金融机构基础数据',
);