		...
		<td>
			...
			<form id="config_form" name="create_form" method="post" action="index.php">
				...
				<table cellspacing="1" cellpadding="0" border="0" width="100%" class="edit view">
						<tbody>
							<tr>
								<th colspan="4"><h4>{$LBL_ASOL_DATE_TIME_OPTS}</h4></th>
							</tr>
							<tr>
				...
				<table cellspacing="1" cellpadding="0" border="0" width="100%" class="edit view">
						<tbody>
							<tr>
								<th colspan="4"><h4>{$LBL_ASOL_PAGINATION}</h4></th>
							</tr>
							<tr>
								<td scope="col" nowrap="nowrap" width="15%">
				...
				<table cellspacing="1" cellpadding="0" border="0" width="100%" class="edit view">
						<tbody>
							<tr>
								<th colspan="4"><h4>{$LBL_ASOL_PDF_OPTS}</h4></th>
							</tr>
							<tr>
								<td scope="col" nowrap="nowrap" width="15%">
				...
				{if ($isAdmin == true)}
					...
					<table cellspacing="1" cellpadding="0" border="0" width="100%" class="edit view">
							<tbody>
								<tr>
									<th colspan="4"><h4>{$LBL_ASOL_SCHEDULED_OPTS}</h4></th>
								</tr>
								<tr>
				...
				{if ($isAdmin == true)}
					...
					<table cellspacing="1" cellpadding="0" border="0" width="100%" class="edit view">
							<tbody>
								<tr>
									<th colspan="4"><h4>{$LBL_ASOL_EXPORTED_CSS}</h4></th>
								</tr>
								...
								<tr>
									...
									<td nowrap="nowrap" width="35%">
										...
										<input type="button" value="{$LBL_ASOL_RESTORE}" onclick="document.css_form.return_action.value = 'restoreCSS'; document.css_form.action='index.php?module=Administration&action=asolConfig'; document.css_form.target='_self'; document.css_form.submit();">						
									...
									<td nowrap="nowrap" width="35%">
										...
										<input type="file" name="uploadedCSS">&nbsp;&nbsp;<input type="button" value="{$LBL_ASOL_UPLOAD}" onclick="document.css_form.return_action.value = 'uploadCSS'; document.css_form.action='index.php?module=Administration&action=asolConfig'; document.css_form.target='_self'; document.css_form.submit();">					
