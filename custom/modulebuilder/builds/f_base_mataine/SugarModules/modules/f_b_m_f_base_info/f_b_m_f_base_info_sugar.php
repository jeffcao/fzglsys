 ...
 * PLACE ANY CUSTOMIZATIONS IN f_b_m_f_base_info
 */

require_once('include/SugarObjects/templates/company/Company.php');

class f_b_m_f_base_info_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'f_b_m_f_base_info';
	var $object_name = 'f_b_m_f_base_info';
	var $table_name = 'f_b_m_f_base_info';
	...
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		function f_b_m_f_base_info_sugar(){	
		parent::Company();
	}
