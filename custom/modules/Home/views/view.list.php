...
class HomeViewList extends ViewList{
 	...
 	function display() {
		...
		//************************************//
		require_once("modules/Home/AlineaSolPublishHomePageFunctions.php");
		
		$mod_strings = return_module_language($current_language, 'Home');
	
		asol_managePublishHomePageActions::managePublishHomePageActions($mod_strings);
		
		echo asol_managePublishHomePageActions::getManagementHomePageHtml($mod_strings); 
		echo asol_managePublishHomePageActions::getManagementPageTabsHtml($mod_strings);
		//************************************//
		//*****AlineaSol PublishHomePage******//
		//************************************//
