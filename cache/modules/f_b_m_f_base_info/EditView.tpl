...
{sugar_translate label='LBL_ACCOUNT_INFORMATION' module='f_b_m_f_base_info'}
<script>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_NAME' module='f_b_m_f_base_info'}{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_PHONE_OFFICE' module='f_b_m_f_base_info'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_WEBSITE' module='f_b_m_f_base_info'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_FAX' module='f_b_m_f_base_info'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_TICKER_SYMBOL' module='f_b_m_f_base_info'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_PHONE_ALT' module='f_b_m_f_base_info'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_RATING' module='f_b_m_f_base_info'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_EMPLOYEES' module='f_b_m_f_base_info'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_OWNERSHIP' module='f_b_m_f_base_info'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_INDUSTRY' module='f_b_m_f_base_info'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_TYPE' module='f_b_m_f_base_info'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.f_b_m_f_base_info_type.name}" 
id="{$fields.f_b_m_f_base_info_type.name}" 
title=''       
>
{if isset($fields.f_b_m_f_base_info_type.value) && $fields.f_b_m_f_base_info_type.value != ''}
{html_options options=$fields.f_b_m_f_base_info_type.options selected=$fields.f_b_m_f_base_info_type.value}
{else}
{html_options options=$fields.f_b_m_f_base_info_type.options selected=$fields.f_b_m_f_base_info_type.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.f_b_m_f_base_info_type.options }
{capture name="field_val"}{$fields.f_b_m_f_base_info_type.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.f_b_m_f_base_info_type.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.f_b_m_f_base_info_type.name}" 
id="{$fields.f_b_m_f_base_info_type.name}" 
title=''          
>
{if isset($fields.f_b_m_f_base_info_type.value) && $fields.f_b_m_f_base_info_type.value != ''}
...
<input
id="{$fields.f_b_m_f_base_info_type.name}-input"
name="{$fields.f_b_m_f_base_info_type.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.f_b_m_f_base_info_type.name}-image"></button><button type="button"
id="btn-clear-{$fields.f_b_m_f_base_info_type.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.f_b_m_f_base_info_type.name}-input', '{$fields.f_b_m_f_base_info_type.name}');sync_{$fields.f_b_m_f_base_info_type.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.f_b_m_f_base_info_type.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.f_b_m_f_base_info_type.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.f_b_m_f_base_info_type.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.f_b_m_f_base_info_type.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.f_b_m_f_base_info_type.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.f_b_m_f_base_info_type.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.f_b_m_f_base_info_type.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.f_b_m_f_base_info_type.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.f_b_m_f_base_info_type.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ANNUAL_REVENUE' module='f_b_m_f_base_info'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='f_b_m_f_base_info'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{sugar_translate label='LBL_ADDRESS_INFORMATION' module='f_b_m_f_base_info'}
<script>
...
{sugar_translate label='LBL_EMAIL_ADDRESSES' module='f_b_m_f_base_info'}
<script>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_EMAIL' module='f_b_m_f_base_info'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{sugar_translate label='LBL_DESCRIPTION_INFORMATION' module='f_b_m_f_base_info'}
<script>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DESCRIPTION' module='f_b_m_f_base_info'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
<script type="text/javascript">
addForm('EditView');addToValidate('EditView', 'name', 'name', true,'{/literal}{sugar_translate label='LBL_NAME' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'date_entered_date', 'date', false,'创建日期' );
addToValidate('EditView', 'date_modified_date', 'date', false,'修改日期' );
addToValidate('EditView', 'modified_user_id', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'created_by', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_CREATED' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATED' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'description', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'deleted', 'bool', false,'{/literal}{sugar_translate label='LBL_DELETED' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_id', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_ID' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'f_b_m_f_base_info_type', 'enum', false,'{/literal}{sugar_translate label='LBL_TYPE' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'industry', 'enum', false,'{/literal}{sugar_translate label='LBL_INDUSTRY' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'annual_revenue', 'varchar', false,'{/literal}{sugar_translate label='LBL_ANNUAL_REVENUE' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'phone_fax', 'phone', false,'{/literal}{sugar_translate label='LBL_FAX' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'billing_address_street', 'varchar', false,'{/literal}{sugar_translate label='LBL_BILLING_ADDRESS_STREET' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'billing_address_street_2', 'varchar', false,'{/literal}{sugar_translate label='LBL_BILLING_ADDRESS_STREET_2' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'billing_address_street_3', 'varchar', false,'{/literal}{sugar_translate label='LBL_BILLING_ADDRESS_STREET_3' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'billing_address_street_4', 'varchar', false,'{/literal}{sugar_translate label='LBL_BILLING_ADDRESS_STREET_4' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'billing_address_city', 'varchar', false,'{/literal}{sugar_translate label='LBL_BILLING_ADDRESS_CITY' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'billing_address_state', 'varchar', false,'{/literal}{sugar_translate label='LBL_BILLING_ADDRESS_STATE' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'billing_address_postalcode', 'varchar', false,'{/literal}{sugar_translate label='LBL_BILLING_ADDRESS_POSTALCODE' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'billing_address_country', 'varchar', false,'{/literal}{sugar_translate label='LBL_BILLING_ADDRESS_COUNTRY' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'rating', 'varchar', false,'{/literal}{sugar_translate label='LBL_RATING' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'phone_office', 'phone', false,'{/literal}{sugar_translate label='LBL_PHONE_OFFICE' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'phone_alternate', 'phone', false,'{/literal}{sugar_translate label='LBL_PHONE_ALT' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'website', 'url', false,'{/literal}{sugar_translate label='LBL_WEBSITE' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'ownership', 'varchar', false,'{/literal}{sugar_translate label='LBL_OWNERSHIP' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'employees', 'varchar', false,'{/literal}{sugar_translate label='LBL_EMPLOYEES' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'ticker_symbol', 'varchar', false,'{/literal}{sugar_translate label='LBL_TICKER_SYMBOL' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'shipping_address_street', 'varchar', false,'{/literal}{sugar_translate label='LBL_SHIPPING_ADDRESS_STREET' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'shipping_address_street_2', 'varchar', false,'{/literal}{sugar_translate label='LBL_SHIPPING_ADDRESS_STREET_2' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'shipping_address_street_3', 'varchar', false,'{/literal}{sugar_translate label='LBL_SHIPPING_ADDRESS_STREET_3' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'shipping_address_street_4', 'varchar', false,'{/literal}{sugar_translate label='LBL_SHIPPING_ADDRESS_STREET_4' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'shipping_address_city', 'varchar', false,'{/literal}{sugar_translate label='LBL_SHIPPING_ADDRESS_CITY' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'shipping_address_state', 'varchar', false,'{/literal}{sugar_translate label='LBL_SHIPPING_ADDRESS_STATE' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'shipping_address_postalcode', 'varchar', false,'{/literal}{sugar_translate label='LBL_SHIPPING_ADDRESS_POSTALCODE' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'shipping_address_country', 'varchar', false,'{/literal}{sugar_translate label='LBL_SHIPPING_ADDRESS_COUNTRY' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'email1', 'varchar', false,'{/literal}{sugar_translate label='LBL_EMAIL' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidate('EditView', 'email_addresses_non_primary', 'email', false,'{/literal}{sugar_translate label='LBL_EMAIL_NON_PRIMARY' module='f_b_m_f_base_info' for_js=true}{literal}' );
addToValidateBinaryDependency('EditView', 'assigned_user_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='f_b_m_f_base_info' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='f_b_m_f_base_info' for_js=true}{literal}', 'assigned_user_id' );
