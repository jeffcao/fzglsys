...
class SugarWidgetSubPanelTopButtonAsolCreateActivity extends SugarWidgetSubPanelTopButton {
    ...
    function display(&$widget_data) {
        ...
        $button = '<form id="CreateStartEventForm" name="CreateStartEventForm" action="index.php" method="post">
						...
						<input type="hidden" name="return_relationship" value="asol_events_asol_activity">
